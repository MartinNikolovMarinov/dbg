...
using Elf32_Addr = u32; // Program address
using Elf32_Off = u32;  // File offset
...
static inline i64 decodePPC64LocalEntryOffset(unsigned Other) {
...
struct Elf32_Sym {
  ...
  void setBindingAndType(unsigned char b, unsigned char t) {
    st_info = static_cast<unsigned char>((b << 4) + (t & 0x0f));
  }
};
...
struct Elf32_Rel {
  ...
  unsigned char getType() const { return static_cast<unsigned char>(r_info & 0x0ff); }
...
struct Elf64_Rel {
  ...
  Elf64_Word getType() const { return static_cast<Elf64_Word>(r_info & 0xffffffffL); }
  void setSymbol(Elf64_Word s) { setSymbolAndType(s, getType()); }
  void setType(Elf64_Word t) { setSymbolAndType(getSymbol(), t); }
  void setSymbolAndType(Elf64_Word s, Elf64_Word t) {
    r_info = (static_cast<Elf64_Xword>(s) << 32) + (t & 0xffffffffL);
  }
};
...
const char* convertEMachineToArchName(u16 EMachine) {
    switch (EMachine) {
        ...
        case EM_PDP10:         return "pdp10";
        case EM_PDP11:         return "pdp11";
        case EM_FX66:          return "fx66";
        case EM_ST9PLUS:       return "st9plus";
        ...
        case EM_ARC_COMPACT:   return "arc_compact";
        ...
        case EM_COREA_1ST:     return "corea_1st";
        case EM_COREA_2ND:     return "corea_2nd";
        case EM_ARC_COMPACT2:  return "arc_compact2";
        ...
        case EM_MCHP_PIC:      return "mchp_pic";
        case EM_INTEL205:      return "intel205";
        case EM_INTEL206:      return "intel206";
        case EM_INTEL207:      return "intel207";
        case EM_INTEL208:      return "intel208";
        case EM_INTEL209:      return "intel209";
        case EM_KM32:          return "km32";
        case EM_KMX32:         return "kmx32";
        case EM_KMX16:         return "kmx16";
        case EM_KMX8:          return "kmx8";
        case EM_KVARC:         return "kvarc";
        case EM_CDP:           return "cdp";
        case EM_COGE:          return "coge";
        case EM_COOL:          return "cool";
        case EM_NORC:          return "norc";
        case EM_CSR_KALIMBA:   return "csr_kalimba";
        case EM_AMDGPU:        return "amdgpu";
        case EM_RISCV:         return "riscv";
        case EM_LANAI:         return "lanai";
        case EM_BPF:           return "bpf";
        case EM_VE:            return "ve";
